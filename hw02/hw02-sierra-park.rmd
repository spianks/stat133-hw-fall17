...
The correlation is lower for more established players. This means that EFT and Salary are not really related to each other.
However, compared to the first plot, the lowess line of the second plot seems to be a little more steeper since it is less curvy. 
